<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckoutFormCreate.aspx.cs" Inherits="PosFixPaymentDemo.CheckoutFormCreate" %>
...
<fieldset>
	...
	<label style="font-weight: bold;">Ad :</label> Ahmet<br> <label
		style="font-weight: bold;">Soyad :</label> Veli <br> <label
		style="font-weight: bold;">Adres :</label> Mevlüt Pehlivan Mah.
	PosFix Plaza Şişli <br> <label style="font-weight: bold;">Posta Kodu
...
<fieldset>
	...
	<label style="font-weight: bold;">Ad :</label> Ahmet<br> <label
		style="font-weight: bold;">Soyad :</label> Veli<br> <label
		style="font-weight: bold;">Adres :</label> Mevlüt Pehlivan Mah.
	PosFix Plaza Şişli<br> <label style="font-weight: bold;">Posta Kodu :</label>
	...
	<label style="font-weight: bold;">Vergi Numarası :</label> 123456<br> <label
		...
		style="font-weight: bold;">Firma Adı:</label> PosFix
</fieldset>
<br />
<br />
	<fieldset>
        ...
        <label style="font-weight: bold;">CallbackUrl :</label> https://apitest.posfix.com.tr/rest/payment/threed/test/result
		<br>
	</fieldset>
