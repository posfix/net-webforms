<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PosFixPaymentDemo.Default" %>
...
<form action="" method="post" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<asp:Button ID="BtnApi3DPaymentInOneStep" runat="server" Text="3D Ödeme" class="btn btn-success" OnClick="BtnApi3DPaymentInOneStep_Click" />
		</div>
	</div>
